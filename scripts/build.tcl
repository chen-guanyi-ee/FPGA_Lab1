...
open_run synth_1
report_utilization -file [file join $root synthesis_utilization.rpt]
launch_runs impl_1 -to_step route_design -jobs 4
wait_on_run impl_1
if {[get_property PROGRESS [get_runs impl_1]] ne "100%"} {error "Implementation failed"}
open_run impl_1
report_utilization -file [file join $root implementation_utilization.rpt]
report_timing_summary -file [file join $root timing_summary.rpt]
report_drc -file [file join $root drc.rpt]
